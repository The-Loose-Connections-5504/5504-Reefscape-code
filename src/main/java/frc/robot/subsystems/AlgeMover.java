...
public class AlgeMover extends SubsystemBase {
  private final SparkMax kMoverRoatater = new SparkMax(Constants.OperatorConstants.algaeRotater, MotorType.kBrushless);
  private final SparkMax kIntake = new SparkMax(Constants.OperatorConstants.algaeMoverID, MotorType.kBrushless);
